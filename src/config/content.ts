...
export const WELCOME: { title: string; intro: string; sections: ContentSection[]; closing: string } =
  {
    title: 'THE DESK',
    intro:
      'An international trading community built around research, process and execution.\n' +
    ...
    sections: [
      ...
      },
      {
        heading: 'ON LOSSES',
        body:
          'Losing periods are a normal property of any strategy with positive expectancy. ' +
    ...
    closing:
      'No financial advice is given here. Nothing in this server is a recommendation to trade. ' +
      'You are responsible for your own risk.',
  };

export const RULES: { title: string; intro: string; rules: string[]; enforcement: string } = {
  title: 'COMMUNITY RULES',
  intro:
    'These rules exist to keep the signal-to-noise ratio high. They are enforced consistently, ' +
  ...
  enforcement:
    'Breaking these results in a warning, a timeout, a removal or a ban depending on severity and intent. ' +
