...
export interface ResourceTopic {
  ...
  key: string;
  /** Shown in the command picker and as the embed title. */
  label: string;
  summary: string;
...
export function findTopic(key: string): ResourceTopic | undefined {
  return RESOURCE_TOPICS.find((topic) => topic.key === key);
}
